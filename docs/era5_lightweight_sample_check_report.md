...
- 判定阈值：抽样均值偏差 `<= 1.00°C`；高温分层均值偏差和单点绝对偏差 P95 `<= 2.00°C`。

## 城市级结论

| 城市 | 样本 | NASA均值 | ERA5均值 | 均值偏差 | 单点P95绝对偏差 | 高温尾部偏差 | 状态 |
|---|---:|---:|---:|---:|---:|---:|---|
| 阿瓦士 | 100 | 36.71 | 35.82 | -0.89 | 5.58 | -2.51 | 需第三/第四源投票 |
| 吉赞 | 100 | 33.98 | 32.55 | -1.44 | 4.12 | -2.91 | 需第三/第四源投票 |
| 科威特市 | 100 | 34.17 | 34.25 | 0.08 | 3.10 | -0.49 | 需第三/第四源投票 |

## 投票触发

以下城市超过阈值，后续只针对这些城市和争议时段引入第三、第四源：

- 阿瓦士：高温分层均值偏差 2.68°C > 2.00°C；单点绝对偏差 P95 5.58°C > 2.00°C
- 吉赞：抽样均值偏差 1.44°C > 1.00°C；高温分层均值偏差 2.91°C > 2.00°C；单点绝对偏差 P95 4.12°C > 2.00°C
- 科威特市：单点绝对偏差 P95 3.10°C > 2.00°C
